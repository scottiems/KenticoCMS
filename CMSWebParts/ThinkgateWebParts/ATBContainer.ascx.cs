...
public partial class CMSWebParts_ThinkgateWebParts_ATBContainer : CMSAbstractWebPart, IAssociationParameters
{
    ...
    void Page_Init()
    {
        if (associationControlTemplate != null)
        {
            ...
            phATBTemplatePlaceHolder.Controls.Add(container);
        }
