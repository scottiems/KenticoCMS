<%@ Page Title="" Language="C#" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" AutoEventWireup="true" 
    ...
    CodeFile="ReferenceCenterEdit.aspx.cs" Inherits="CMSModules_Content_CMSDesk_Edit_ReferenceCenterEdit" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="plcContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            enableDisableClientTargets();
        });

        function enableDisableClientTargets() {
            var checked = jQuery("input[id*=IsGlobal_checkbox]").is(":checked");
            jQuery("table[id*=ClientTargets_list]").find("input[type=checkbox]").each(function (i, e) {
                if (checked === true) {
        ...
        jQuery(function () {
            ...
            jQuery("input[id*=IsGlobal_checkbox]").click(function (e) {
                enableDisableClientTargets();
            });
